    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('train_duration', models.TextField(blank=True, null=True)),
                ...
                ('gender_spanish', models.TextField(blank=True, null=True)),
                ('trainer_spanish', models.TextField(blank=True, null=True)),
                ('fitness_goals_spanish', models.TextField(blank=True, null=True)),
                ('injuries_discomfort_spanish', models.TextField(blank=True, null=True)),
                ('dietary_preferences_spanish', models.TextField(blank=True, null=True)),
                ('allergies_spanish', models.TextField(blank=True, null=True)),
                ('medical_conditions_spanish', models.TextField(blank=True, null=True)),
